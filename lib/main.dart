  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        'asistencia': (_) => AsistenciaScreen(),
        'home': (_) => HomePage(),
        'news': (_) => CardScreen(),
        'checking': (_) => CheckAuthScreen(),
        'main': (_) => MainScreen(),
        'entrenamientos': (_) => FormGastosScreen(),
        'statistic': (_) => StatisticPage(),
        'dummy': (_) => DummyScreen(),
        'inicio': (_) => PantallaInicio(),
        'calendario': (_) => CalendarioScreen(),
        'eventos': (_) => Pantallaeventos(),
        'inscripcion': (_) => InscripcionScreen(),
        'editor': (_) => EditorPage(),
        'perfil': (_) => ProfileScreen(),
        'añadirgasto': (_) => AddPage(),
        'marcaasis': (_) => MarcarAsistencia(),
      },
